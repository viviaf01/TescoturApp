...
(function () {
    ...
    angular
            .module('app')
            .factory('EnlistService', EnlistService);

    EnlistService.$inject = ['$cordovaSQLite', 'ApiClientsService', 'ApiLoanService', 'ApiHappyDaysService', 'ApiExpensesTypeService', 'ApiRoutesService', 'session'];

    /**
     * @namespace LoansService
     * @memberOf loans
     */
    function EnlistService($cordovaSQLite, ApiClientsService, ApiLoanService, ApiHappyDaysService, ApiExpensesTypeService, ApiRoutesService,  session) {
        var service = {
