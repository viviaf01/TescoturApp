...
(function () {
    ...
    function syncservice($cordovaSQLite, ApiClientsService, ApiLoanService, ApiHappyDaysService, ApiExpensesTypeService, ApiRoutesService, session, $http) {
        var service = {
            ...
            consultarDetalle: __consultarDetalle,
...
//, ['1', '1']
        ...
        function __consultarDetalle(){
            
            return $cordovaSQLite.execute(db, 'SELECT * FROM detalletarjeta ')
                    .then(
                            function (res) {
            ...
            __tarjetas().then(
                    function (tarjetas) {
                        __gastos().then(
                                function(gastos){
                                   ///envio
                                    $http.post('https://www.exdren.net/datos_app/guardar.php', {"tarjetas": tarjetas,"gastos":gastos})
