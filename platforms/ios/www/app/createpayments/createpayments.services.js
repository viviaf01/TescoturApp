...
(function () {
  ...
  angular
    .module('app')
    .factory('CreatepaymentsService', CreatepaymentsService);

  CreatepaymentsService.$inject = ['$cordovaSQLite','session'];

  /**
   * @namespace PaymentsService
   * @memberOf Payments
   */
  function CreatepaymentsService($cordovaSQLite,session) {
    var service = {
