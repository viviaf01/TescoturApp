...
(function () {
  ...
  DailyExpensesService.$inject = ['$cordovaSQLite','session','$http'];

  /**
   * @namespace DailyExpensesService
   * @memberOf DailyExpenses
   */
  function DailyExpensesService($cordovaSQLite,session,$http) {
    var service = {
        
      enviarMensaje: __enviarMensaje,
        ///Viejos
    ...
    function __enviarMensaje(data,usuario){
        // console.log("actualizarTarea");
    $http.post('http://www.tescotur.com/app/enviarMensaje', {"remitente":sessionStorage.userId,"destino":data.idconceptoegreso.us_id  ,"mensaje":data.observaciones,"tipo":"Conductor","estado":"Enviado"})
