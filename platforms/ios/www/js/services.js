angular.module('app.services', [])
    .service('ApiUsersService', function($q,$http) { ///datos conductor
        var urlService = "http://www.tescotur.com/app/";
        return {
            get: __get
        }
        function __get(id) {
            ...
            var url = urlService + "conductor/" + id;
            return $http({
                url: url,
                method: 'GET'
            })
...
.service('ApiMovilService', function($q,$http) {
        var urlService = "http://www.tescotur.com/app/";
        return {
            get: __get
        }
        function __get(id) {
            ...
            var url = urlService + "vehiculos/" + id;
            return $http({
                url: url,
                method: 'GET'
            })
...
.service('ApiMensajesService', function($q,$http) {
        var urlService = "http://www.tescotur.com/app/";
        return {
            get: __get
        }
        function __get(id) {
            ...
            var url = urlService + "mensajes/" + id;
            return $http({
                url: url,
                method: 'GET'
            })
...
.service('ApiRecorridosService', function($q,$http,session) {
        var urlService = "http://www.tescotur.com/app/";
        return {
            get: __get
        }
        function __get(id) {
            ...
            var url = urlService + "tareas_dia/" +sessionStorage.userId+ "/"+id;
            return $http({
                url: url,
                method: 'GET'
            })
 ...
 .service('ApiCoordinadoresService', function($q,$http) {
        var urlService = "http://www.tescotur.com/app/";
        return {
            get: __get
        }
        function __get(id) {
            ...
            var url = urlService + "coordinadores";
            return $http({
                url: url,
                method: 'GET'
            })
...
.service('ApiHappyDaysService', function($q,$http,session) {
        ...
        var urlService = "https://www.exdren.net/datos_app/";
