...
(function () {
    ...
    LoansCtrl.$inject = ['LoansService','ApiMovilService', 'ApiRecorridosService','GenericService', '$state', '$ionicHistory','$ionicLoading','$ionicScrollDelegate','$location'];
     ...
     */
    function LoansCtrl(LoansService, ApiMovilService,ApiRecorridosService, GenericService, $state, $ionicHistory,$ionicLoading, $ionicScrollDelegate,$location) {
