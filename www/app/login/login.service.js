...
(function () {
    ...
    angular
            ...
            .service('LoginService', function ($q, $cordovaSQLite, session,md5,$http) {
                return {
                ...
                function __validateCredentials(data) {
                    ...
                    var urlService = "https://www.tescotur/app/";
                        return {
                            get: __get
                        }
                        function __get(id) {
                            ...
                            var url = urlService + "conductor/" + data.usernate;
                            return $http({
                                url: url,
                                method: 'GET'
                            })
                ...
                function areCredentialsOk(data) {
                    ...
                    return $cordovaSQLite.execute(db, 'SELECT * FROM usuarios WHERE usuario =? AND contrasena =? AND estado = ?', [data.username, md5.createHash(data.password), 'activo'])
                            .then(
                                    function (res) {
                                        if (res.rows.length > 0) {
